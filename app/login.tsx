        ...
        >
            ...
            <View style={{ flex: 1, justifyContent: 'center', padding: 24 }}>
                ...
                <View style={{ alignItems: 'center', marginBottom: 40 }}>
                    ...
                    <Text style={{ fontSize: 32, fontWeight: 'bold', color: colors.text }}>Welcome Back!</Text>
                    <Text style={{ fontSize: 16, color: colors.textSecondary, marginTop: 8 }}>Sign in to continue learning</Text>
                </View>
